...
<div class="space-y-8">
    ...
    <section class="bg-white rounded-xl border border-rose-100 shadow-sm p-6">
        ...
        <a href="{{ route('learn.index') }}" class="inline-block mt-4 text-rose-600 text-sm font-medium hover:underline">En savoir plus sur ces compétences →</a>
    </section>

    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <a href="{{ route('chat') }}" class="block p-6 bg-white rounded-xl border border-rose-100 shadow-sm hover:shadow-md hover:border-rose-200 transition">
        ...
        <a href="{{ route('analyze') }}" class="block p-6 bg-white rounded-xl border border-rose-100 shadow-sm hover:shadow-md hover:border-rose-200 transition">
            <span class="text-3xl">📋</span>
        ...
        <a href="{{ route('safety.index') }}" class="block p-6 bg-white rounded-xl border border-rose-100 shadow-sm hover:shadow-md hover:border-rose-200 transition">
