...
@section('title', 'Compétences en ligne')
    ...
    <section class="bg-white rounded-xl border border-rose-100 shadow-sm p-6 space-y-4">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-2"><strong>Astuce :</strong> Nomme l’émotion (« Je suis en colère »), accepte-la, puis choisis une action (fermer l’app, en parler à quelqu’un, utiliser le <a href="{{ route('chat') }}" class="text-rose-600 underline">chat Dam3a</a>).</p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white rounded-xl border border-rose-100 shadow-sm p-6 space-y-4">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-2">Tu as le droit de te sentir en sécurité. En cas d’incident, tu peux <a href="{{ route('analyze') }}" class="text-rose-600 underline">analyser un incident</a> ici et consulter le <a href="{{ route('safety.index') }}" class="text-rose-600 underline">centre de sécurité</a> pour les numéros d’urgence.</p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white rounded-xl border border-rose-100 shadow-sm p-6 space-y-4">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-2">Les bonnes habitudes commencent tôt : ce que tu dis et fais en ligne compte. Tu peux rejoindre nos <a href="{{ route('communities.index') }}" class="text-rose-600 underline">communautés</a> pour échanger dans un cadre bienveillant.</p>
            </div>
        </div>
    </section>
